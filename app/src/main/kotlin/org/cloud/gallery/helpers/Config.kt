...
class Config(context: Context) : BaseConfig(context) {
    ...
    fun removeExcludedFolder(path: String) {
        ...
        val currExcludedFolders = HashSet<String>(excludedFolders)
        currExcludedFolders.removeIf { it.lowercase() == lowerPath }
    ...
    fun removeIncludedFolder(path: String) {
        val lowerPath = path.lowercase()
        val currIncludedFolders = HashSet<String>(includedFolders)
        currIncludedFolders.removeIf { it.lowercase() == lowerPath }
        includedFolders = currIncludedFolders
    }
    ...
    var titleDisplayMode: Int
        get() = prefs.getInt(TITLE_DISPLAY_MODE, TITLE_DISPLAY_MODE_HIDE_ALL)
        set(mode) = prefs.edit().putInt(TITLE_DISPLAY_MODE, mode).apply()
