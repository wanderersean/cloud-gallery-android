...
interface MediaItemBinding {
    ...
    val cloudStatus: ImageView?
    val cloudStatusContainer: android.widget.FrameLayout?
    val cloudUploadProgress: com.google.android.material.progressindicator.CircularProgressIndicator?
}
...
class PhotoListMediaItemBinding(val binding: PhotoItemListBinding) : MediaItemBinding {
    ...
    override val cloudStatus: ImageView? = null
    override val cloudStatusContainer: android.widget.FrameLayout? = null
    override val cloudUploadProgress: com.google.android.material.progressindicator.CircularProgressIndicator? = null
}
...
class PhotoGridMediaItemBinding(val binding: PhotoItemGridBinding) : MediaItemBinding {
    ...
    override val mediumCheck: ImageView = binding.mediumCheck
    override val mediumThumbnail: MySquareImageView = binding.mediumThumbnail
    override val cloudStatus: ImageView? = binding.cloudStatus
    override val cloudStatusContainer: android.widget.FrameLayout? = binding.cloudStatusContainer
    override val cloudUploadProgress: com.google.android.material.progressindicator.CircularProgressIndicator? = binding.cloudUploadProgress
}
