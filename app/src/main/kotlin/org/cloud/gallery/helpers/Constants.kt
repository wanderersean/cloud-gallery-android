...
const val TITLE_DISPLAY_MODE = "title_display_mode"
...
// title display modes
const val TITLE_DISPLAY_MODE_HIDE_ALL = 0
const val TITLE_DISPLAY_MODE_SHOW_MERGED = 1
const val TITLE_DISPLAY_MODE_CLOUD_ONLY = 2
