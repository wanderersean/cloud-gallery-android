...
android {
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "SERVER_BASE_URL", "\"http://47.98.124.235:8080\"")
        }
        release {
            isMinifyEnabled = true
            isShrinkResources = true
            isDebuggable = false  // release 版本禁止调试
            proguardFiles(
            ...
            buildConfigField("String", "SERVER_BASE_URL", "\"https://www.cloud-gallery.cn\"")
        }
    }
